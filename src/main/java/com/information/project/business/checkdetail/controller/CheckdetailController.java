package com.information.project.business.checkdetail.controller;
...
public class CheckdetailController extends BaseController
{
	...
	@Log(title = "银行详情对账对账", action = BusinessType.INSERT)
	@PostMapping("/add")
	@ResponseBody
	...
	@Log(title = "银行详情对账对账", action = BusinessType.UPDATE)
	@PostMapping("/edit")
	@ResponseBody
	...
	@Log(title = "银行详情对账对账", action = BusinessType.DELETE)
	@PostMapping( "/remove")
	@ResponseBody
