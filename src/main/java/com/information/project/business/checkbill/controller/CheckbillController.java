package com.information.project.business.checkbill.controller;
...
public class CheckbillController extends BaseController
{
	...
	@Log(title = "银行总账对账", action = BusinessType.INSERT)
	@PostMapping("/add")
	@ResponseBody
	...
	@Log(title = "银行总账对账", action = BusinessType.UPDATE)
	@PostMapping("/edit")
	@ResponseBody
	...
	@Log(title = "银行总账对账", action = BusinessType.DELETE)
	@PostMapping( "/remove")
	@ResponseBody
